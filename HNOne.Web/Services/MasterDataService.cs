...
namespace HNOne.Web.Services
{
    public class MasterDataService : ApiServiceBase, IMasterDataService
    {
        ...
        /// <param name="request"></param>
        /// <returns></returns>
        public async Task<List<TitleModel>?> GetTitleAsync(int userId, string token, int branchId, string branchIds = "", string opt = "", bool isShowToast = false)
        {
        ...
        /// <param name="request"></param>
        /// <returns></returns>
        public async Task<List<PositionModel>?> GetPositionAsync(int userId, string token, int branchId, string branchIds = "", string opt = "", bool isShowToast = false)
        {
        ...
        /// <param name="isShowToast"></param>
        /// <returns></returns>
        public async Task<List<SalaryParameterModel>?> GetSalaryParameterAsync(int userId, string token, int branchId, string branchIds = "", string opt = "", bool isShowToast = false)
        {
