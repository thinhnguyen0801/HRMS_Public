namespace HNOne.Common
{
    public class ProcessConstants
    {
        ...
        public const string GET_DECISION_DOCUMENT = "get-decision-document";
        ...
        public const string GET_COMBO_TYPE_PREVIOUS_SIGNER_BY_EMPLOYEE = "PREVIOUS_SIGNER_BY_EMPLOYEE"; // nhân viên ký trước đó
